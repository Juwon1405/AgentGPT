...
<Accordion title="Did AgentGPT really email 100 people?">
  ...
  might be available, take a look at our [roadmap](/essentials/roadmap). We
  guarantee that actions such as "sending an email" will only occur with your
  explicit permission.
</Accordion>
...
<Accordion title="What can AgentGPT do?">
  ...
  expand them. To see some of its applications, visit our
  [usecases](/essentials/usecases) page.
</Accordion>
...
<Accordion title="What kind of DFIR help do you need?">
  Please share any available artifacts (incident context, system/network logs,
  packet captures, suspicious files, timeline notes, and host/user activity
  data). With fragmented evidence, we can still produce a thorough
  wiki-ready DFIR report including:

- an executive summary and scope,
- evidence-based findings with clear rationale,
- an incident timeline,
- impact and damage assessment,
- attack path and key timestamps visualized in draw.io,
- and prioritized containment, eradication, and recovery recommendations.
  </Accordion>
